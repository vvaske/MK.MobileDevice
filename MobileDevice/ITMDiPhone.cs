...
namespace MK.MobileDevice
{
    ...
    public class iTMDiPhone
    {
        ...
        */
        ...
        public unsafe string RequestProperty(string key)
        {
            return MobileDevice.AMDeviceCopyValue(iPhoneHandle, 0, key);
        }
        ...
        public unsafe bool IsWiFiEnabled
        {
            get
            {
                long rv;
                MobileDevice.AMDeviceGetWirelessBuddyFlags(this.iPhoneHandle, out rv);
                return rv==2;
            }
        }
